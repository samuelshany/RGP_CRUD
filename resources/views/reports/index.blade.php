...
<div class="col-md-4 mx-4 my-3 text-center d-flex justify-content-center align-items-center " style="justify-content: center;background-color: white;height:100px;
color:black;font-weight:bold" >
  <a style="color: black" href="{{url('/admin/categories/catProduct',$category->id)}}">  {{$category->name}} {{count($category->products)}} {{__('messages.products')}}</a>
</div>
        @endforeach
    </div>
