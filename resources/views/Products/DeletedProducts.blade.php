    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">{{ __('messages.deletedproducts') }}</h4>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($products as $product)
                                            <tr>
                                                ...
                                                <td><a
                                                      class="btn btn-warning"  href="{{ url('admin/products/restore', $product->id) }}">{{ __('buttons.restore') }}</a>
                                                </td>
                                                <td><a onClick="return confirm('{{ __('messages.deleteProduct') }} ')"
                                                      class="btn btn-danger"  href="{{ url('admin/products/forcedelte', $product->id) }}">{{ __('buttons.delete') }}</a>
                                                </td>
                                            </tr>
                                        @endforeach
