    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card card-body">
                <h3 class="mb-0">{{__('messages.addProduct')}}</h3>
...
<option value="{{$category->id}}"> {{$category->name}}</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="name_ar" class="form-control" autocomplete="false"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="description_en" class="form-control" autocomplete="false"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="description_ar" class="form-control" autocomplete="false"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="number" name="price" class="form-control" autocomplete="false"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="number" name="quantity" class="form-control" autocomplete="false"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="file" name="photo" class="form-control" autocomplete="false"
                    ...
                    <div class="form-group mb-0">
                        <div class="offset-sm-3 col-sm-9 d-flex justify-content-end">
                            <button type="submit" class="btn btn-info waves-effect waves-light mt-2 "
                                style="background-color:#00b9f0">{{__('buttons.addProduct')}}
                            </button>
                        </div>
                    </div>
                </form>
